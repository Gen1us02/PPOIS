...
HDD::HDD(int memorySize, int spindleSpeed, const std::string& recordTechnology):
memorySize_(memorySize), spindleSpeed_(spindleSpeed), recordTechnology_(recordTechnology){}
