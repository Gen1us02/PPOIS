...
BluetoothAdapter::BluetoothAdapter(const std::string &connectionInterface, int speed,
                                   int coverageRadius) : connectionInterface_(connectionInterface), speed_(speed),
                                                         coverageRadius_(coverageRadius) {
    port_ = PortType::USB;
}
