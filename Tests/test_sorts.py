...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [-10, 5, 34, 234, 0, 20, 13, -56, -78],
            [-78, -56, -10, 0, 5, 13, 20, 34, 234],
        ),
        ([8.56, 4.32, 5.87, 23.56, 10.34], [4.32, 5.87, 8.56, 10.34, 23.56]),
        (
            [-45.54, -100.549, 45.324, 5.34, 78.31, 2.12, 0.0],
            [-100.549, -45.54, 0.0, 2.12, 5.34, 45.324, 78.31],
        ),
        (
            ["kirill", "dima", "artem", "zhenya", "wolf", "cat"],
            ["artem", "cat", "dima", "kirill", "wolf", "zhenya"],
        ),
        (
            ["fshjhjfs", "adaaj", "qd", "asjd", "ajiokda", "jdasd"],
            ["adaaj", "ajiokda", "asjd", "fshjhjfs", "jdasd", "qd"],
        ),
        (
            [
                Book("Garry Potter", 140, 345),
                Book("Wolf", 78, 122),
                Book("Void", 23, 324),
                Book("ArtemDjDj", 345, 346),
            ],
            [
                Book("Void", 23, 324),
                Book("Wolf", 78, 122),
